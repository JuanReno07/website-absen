    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 py-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-6 relative z-10">
        ...
        <div className="text-center space-y-3 flex flex-col items-center">
          <div className="relative p-[2.5px] rounded-3xl bg-gradient-to-r from-brand-600 via-red-500 to-brand-600 shadow-2xl shadow-brand-500/30 overflow-hidden logo-hover-box">
